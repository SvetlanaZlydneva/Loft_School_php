                ...
                <div class="content-main__container">
                    <div class="products-columns">
                        ...
                        <div class="products-columns__item">
                            ...
                            <div class="products-columns__item__description"><span class="products-price">{{$product->price}} руб</span><a href="about/{{$product->id}}" class="btn btn-blue">Подробнее</a></div>
                        </div>
                        @endforeach
                    </div>
                </div>
